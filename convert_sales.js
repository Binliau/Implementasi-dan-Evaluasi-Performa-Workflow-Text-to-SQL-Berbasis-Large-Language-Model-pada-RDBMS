...
const data = fs.readFileSync('5_sales_data_part1.sql', 'utf8');
...
fs.writeFileSync('5_sales_data_part1_FIXED.sql', output.join('\n'), 'utf8');
console.log('✅ Created 5_sales_data_part1_FIXED.sql');
